...
// Code at this directory copied from
//
//https://github.com/open-telemetry/opentelemetry-collector/tree/main/pdata v0.66.0 release
//
// imports optimized manually for reduced binary size
