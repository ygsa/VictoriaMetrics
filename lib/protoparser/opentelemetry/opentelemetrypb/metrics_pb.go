...
func (m *ScopeMetrics) GetScope() InstrumentationScope {
	if m != nil {
		return m.Scope
	}
...
type NumberDataPoint struct {
	...
	Attributes []KeyValue `protobuf:"bytes,7,rep,name=attributes,proto3" json:"attributes"`
...
type HistogramDataPoint struct {
	...
	// Attribute keys MUST be unique (it is not allowed to have more than one
	// attribute with the same key).
	Attributes []KeyValue `protobuf:"bytes,9,rep,name=attributes,proto3" json:"attributes"`
	// StartTimeUnixNano is optional but strongly encouraged, see the
	// the detailed comments above Metric.
	//
	// Value is UNIX Epoch time in nanoseconds since 00:00:00 UTC on 1 January
...
func (m *ExponentialHistogramDataPoint) GetAttributes() []KeyValue {
	if m != nil {
		return m.Attributes
	}
	return nil
...
type Exemplar struct {
	...
	FilteredAttributes []KeyValue `protobuf:"bytes,7,rep,name=filtered_attributes,json=filteredAttributes,proto3" json:"filtered_attributes"`
	...
	SpanId SpanID `protobuf:"bytes,4,opt,name=span_id,json=spanId,proto3,customtype=go.opentelemetry.io/collector/pdata/internal/data.SpanID" json:"span_id"`
	// (Optional) Trace ID of the exemplar trace.
	// trace_id may be missing if the measurement is not recorded inside a trace
	// or if the trace is not sampled.
	TraceId TraceID `protobuf:"bytes,5,opt,name=trace_id,json=traceId,proto3,customtype=go.opentelemetry.io/collector/pdata/internal/data.TraceID" json:"trace_id"`
}
